...
<header>
    <div class="social">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmm-bTEQCah55y8cxaOehZr9IAW-gyY2zgqF1LFHVe1g&s" alt="Logo">
...
<form action="home" method="post">
    <div id="firstNameField">
        <p>First Name:</p>
        <input type="text" id="firstName" name="name" onblur="validateFirstName()"><br>
        <span class="error-message" id="firstNameError"><br>Please enter a valid first name.</span>
        <p>Last Name:</p>
        <input type="text" id="lastName" name="lname" onblur="validateLastName()"><br>
    ...
    <div id="emailField">
        ...
        <span class="error-message" id="emailError">Please enter a valid mail</span>
        <p>PhNo</p>
        <input type="text" id="mobileNumber" name="mobileNo" onblur="validateMobileNumber()"><br>
        <span class="error-message" id="mobileNumberError">Please enter a valid number</span>
    </div>
    <div>
        <p>Payment Mode</p>
       <select id="paymentmode" name="payment">
           <option value="creditcard">Credit Card</option>
           <option value="debitcard">Debit Card</option>
           <option value="paypal">PayPal</option>
       </select>
        <p name="checkIn">Check In Date</p>
        <input type="date" id="selectDate" name="date">
    </div>


   <div>
       <p name="checkOut">Check Out Date</p>
       <input type="date" id="selecDate" name="date">
       <p>No Of Adults</p>
       <input type="text" name="adult">
   </div>
    <div>
        <p name="children">No Of Children</p>
        <input type="text" name="child">
        <p name="room">No Of Rooms</p>
...
<script type="text/javascript">
    document.getElementById('infoCorrect').addEventListener('change', function() {
    if (this.checked) {
