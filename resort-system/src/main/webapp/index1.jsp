...
<form action="user" method="post">
  ...
  <div id="emailField">
    ...
    <div id="comments">
        <p>Comments</p>
        <input type="text" id="comment" name="comments" onblur="validateComments()"><br>
        <span class="error-message" id="commentError">Comment should contain at least 25 characters</span>
